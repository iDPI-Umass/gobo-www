// Adapted from Pikulin.PW ResizableHeight Plugin
// https://github.com/pikulinpw/ckeditor5-resizableheight

import Plugin from '@ckeditor/ckeditor5-core/src/plugin';

class ResizableHeight extends Plugin {
    init() {
        ...
        const css = `
          ...
          .ck .ck.ck-editor__main.ck-focused {
              outline: 2px solid var(--gobo-color-primary) !important;
          }
